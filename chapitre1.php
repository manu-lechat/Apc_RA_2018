  ...
  <i id="chapitre1"></i>
    ...
    <section class="chapitre1">
      ...
      <header class="header_chapitre">
          ...
          <h1 class="">
            <span class="content">1. Profil de l'agence</span>
          </h1>
      </header>
      ...
      <article class="row ">
        ...
        <div class="col_33pc">
          ...
          <ul class="liste_puces">
            <li><span class="bold">L’Agence d’accélération de la transition énergétique</span> en s’appuyant notamment sur son rôle de conseil neutre gratuit et indépendant auprès des citoyens et sur la conduite du chantier de rénovation énergétique du bâti parisien et d’accompagnement à une mobilité durable.</li>
            <li><span class="bold">Le laboratoire de la transition écologique</span> en conduisant des projets partenariaux innovants à commencer dès 2018 par le pilotage avec la Ville de Paris de task forces à destination des acteurs économiques, et l'accompagnement à l’émergence de nouveaux métiers.</li>
...
<div class="saut_de_page"></div>
      <article class="row  titre_center_container">
        ...
        <h2 class="titre_h2_bandeau">L’APC en bref</h2>
      ...
      <article class="row  ">
        ...
        <div class="col_50pc">
          ...
          <img src="img/intro/secteurs.svg" alt="" class="infographie appear_on_scroll appear_pop">
        </div>
        ...
        <div class="col_50pc">
          ...
          <img src="img/intro/metiers.svg" alt="" class="infographie appear_on_scroll appear_pop">
        </div>

      </article>


      <article class="row appear_on_scroll">
        ...
        <div class="col_50pc">
          <h2 class="titre_h2">
            <span>25 Salariés</span>
          </h2>
          <img src="img/intro/salaries.svg" alt="" class="infographie appear_on_scroll appear_pop">
        </div>
      ...
      <article class="hachures noprint">
        <div class="center"><br><br>
          <h2 class="titre_h2_bandeau">Une équipe de 25 collaborateurs en 2017</h2>
        ...
        <div class="row module_equipe appear_on_scroll">
          ...
          <div class="verbatim_container">

            <div class="swiper-container swiper_equipe_verbatims">
                <!-- Additional required wrapper -->
                <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide">
        ...
        <article class="row">
          ...
          <div class="col_100pc">
          <p>
            <h2 class="titre_bgcolor"><span>3 axes de travail :</span></h2>
      ...
      <article class="row titre_center_container">
        ...
        L’Agence Parisienne du Climat est une agence multi-partenariale.<br>

7 membres fondateurs et observateurs et 90 adhérents et partenaires

      </p>
      <br><p class="center">
              Sa gouvernance, composée d’acteurs publics et privés, constitue une alliance d’acteurs, <br>
              avec pour finalité l’émergence de solutions nouvelles et la démultiplication des actions.
              </p>
      <a href="http://www.apc-paris.com/fiche-adherent/ville-paris" target="_blank"><img class="appear_on_scroll appear_pop" style="height:100px" src="img/intro/logos_gouvernance/mairie-paris.gif" alt=""></a>
      <a href="http://www.apc-paris.com/fiche-adherent/ratp" target="_blank"><img class="appear_on_scroll appear_pop" style="height:100px" src="img/intro/logos_gouvernance/ratp.gif" alt=""></a>
      <a href="http://www.apc-paris.com/fiche-adherent/edf" target="_blank"><img class="appear_on_scroll appear_pop" style="height:100px" src="img/intro/logos_gouvernance/edf.gif" alt=""></a>
      <a href="http://www.apc-paris.com/fiche-adherent/meteo-france" target="_blank"><img class="appear_on_scroll appear_pop" style="height:100px" src="img/intro/logos_gouvernance/meteo-france.gif" alt=""></a>
      <a href="http://www.apc-paris.com/fiche-adherent/cpcu" target="_blank"><img class="appear_on_scroll appear_pop" style="height:100px" src="img/intro/logos_gouvernance/cpcu.gif" alt=""></a>
      <a href="http://www.apc-paris.com/fiche-adherent/ademe" target="_blank"><img class="appear_on_scroll appear_pop" style="height:100px" src="img/intro/logos_gouvernance/ademe.gif" alt=""></a>
...
<a class="bouton" target="_blank" href="http://www.apc-paris.com/annuaire-adherents">Consultez l’annuaire des adhérents</a></p>
          ...
          L’APC poursuit son action à l’international en participant à des grands réseaux engagés sur le climat ou en accompagnant des villes dans la mise en œuvre de leur Plan Climat.
              ...
              <div class="row ">
                <div class="col_33pc">
                  ...
                  <article>
                    <h2 class="titre_bgcolor"><span>Rencontre du C40 à l’Agence</span></h2>
                    <p class="maj bold">juin 2017</p>
                    <p>
                     Rencontre de Mark Watts, directeur général du C40 CITIES  et son équipe parisienne pour échanger sur l’action de l’Agence Parisienne du Climat.
                     Participation à un webinaire organisé avec les membres du <a href="http://www.c40.org/cities" target="_blank"> C40 </a>sur la mobilisation et la sensibilisation des citoyens.
                    </p>
                  </article>

                  <article>
                      <h2 class="titre_bgcolor"><span>UCCRN, lancement du Hub européen</span></h2>
  ...
  En phase opérationnelle, l’APC participait activement au <a href="http://www.uccrn-europe.org/paris-july-06-2017" target="_blank"> lancement du HUB européen de l’UCCRN.</a>
                  ...
                  <article>
                      <h2 class="titre_bgcolor"><span>Lancement du GUAPO à Paris</span></h2>
                    <p class="maj bold">novembre 2017</p>
                    <p>
                      En novembre 2017, l’APC a participé à la préparation et au lancement du
                      <a href="https://presse.paris.fr/wp-content/uploads/2017/11/Lancement-du-Guapo-l%E2%80%99Observatoire-mondial-des-villes-sur-la-qualit%C3%A9-de-l%E2%80%99air.pdf" target="_blank">Guapo</a>,
                      <span class="bold">l’Observatoire mondial des villes sur la qualité de l’air</span> qui s’est tenu à l’Hôtel de Ville.
             ...
             <div class="img_container">
              ...
              <div class="legende_diaporama">Anne Girault, Directrice de l'Agence Parisienne du Climat et Lebo Molefe,<br> Directrice des services de Johannesburg</div>
               ...
               <div class="col_33pc">
                     ...
                     <article>
                         <h2 class="titre_bgcolor"><span>Accompagnement de Varsovie </span><br><span>et de Johannesburg en février 2017</span></h2>
                       <p>
               ...
               <div class="col_33pc">
                       ...
                       <article>
                         <h2 class="titre_bgcolor"><span>Accueil de délégations étrangères</span></h2>
                         <p>
                         Accueil de trois  délégations étrangères à l’Agence Parisienne du Climat : <span class="bold"> bulgare, jordanienne et mexicaine</span>.
                         </p>
                       </article>
               </div>
