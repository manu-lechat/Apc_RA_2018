    ...
    <section class="intro">
      ...
      <header class="header_chapitre top_header">
            <div class="photo_container">
              <div class="credits_photo">Crédit : Awax Design</div>
              <img src="img/intro/trocadero.jpg" alt="" class="bg_img">

                <img src="img/intro/logo_white.png" alt="" class="logo">
                <h1>La plateforme de référence énergie-climat <br>pour comprendre et agir à Paris</h1>
...
<section class="chapitre1">
  <div class="row center">
    <div class="col_100pc">
    <h2 class="titre_h2_bandeau">Chiffres clés 2017</h2>
    <p class="txt_bigIntroMaxi">
      L’APC compte 80 adhérents <br>et 25 collaborateurs
    </p>
    <img src="img/intro/chiffres_cles.svg" alt="">
    </div>
  </div>
</section>
