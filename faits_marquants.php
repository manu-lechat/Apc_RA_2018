...
<section class="faits_marquants">

      <div class="row">

        <div class="col_33pc">
          <article>
            <h2 class="titre_majBoldColor">Janvier</h2>
            <p>
              <span class="bold">Assises européennes de la Transition énergétique</span>, Bordeaux – Conférence : comment renforcer la prise en compte de l’énergie dans les projets urbains – Résultats de l’étude Urban Learning réalisée dans le cadre du programme européen Horizon 2020.
            </p>
            <div class="img_container">
            <span class="credits_photo">© APC</span>
              <img src="img/faits_marquants/012.jpg" alt="">
            </div>
          </article>
          <article>
            <h2 class="titre_majBoldColor">Février</h2>
            <p>
            <span class="bold">5<sup>e</sup> Forum de l’Eco-Rénovation en copropriété</span> organisé à la Mairie du 20<sup>e</sup>, en ouverture à la Quinzaine de l’Eco-rénovation : 420 visiteurs, 40 exposants.
            </p>
            <p>
            Ateliers de concertation avec les acteurs économiques et institutionnels parisiens dans le cadre de l’élaboration du <span class="bold">nouveau Plan Climat de Paris</span> co-organisés avec la Ville de Paris.
            </p>
            <div class="img_container">
            <span class="credits_photo">© APC</span><img src="img/faits_marquants/009.jpg" alt=""></div>
          </article>
          <article>
          ...
          <article>
            <h2 class="titre_majBoldColor">Avril</h2>
            <p>
            Animation d’un réseau de 200 conseillers utilisateurs de la plateforme <span class="bold">CoachCopro</span> France  </p>.
            <div class="img_container"> <span class="credits_photo">© Sébastien Borda <br>/ APC</span> <img src="img/faits_marquants/001.jpg" alt=""></div>
          </article>


         <article>
           <h2 class="titre_majBoldColor">Mai</h2>
           <p>
            <span class="bold">Création d’un annuaire en ligne</span> des professionnels de la rénovation des copropriétés affiliés au CoachCopro.
           </p>

          <p>
           <span class="bold">Publication du bulletin climatique parisien de l’hiver 2017</span>, en partenariat avec Météo-France. C’était l’hiver le plus sec depuis 25 ans,, marqué par un épisode anticyclonique en décembre, qui a favorisé un pic de pollution particulièrement intense.
        </p>

           <div class="img_container">
           <span class="credits_photo">© APC</span> <img src="img/faits_marquants/003.jpg" alt=""></div>
         </article>
       ...
       <div class="col_33pc">
         ...
         <article>
           ...
           <div class="img_container">
           <span class="credits_photo">© APC</span><img src="img/faits_marquants/011.jpg" alt=""></div>
         </article>
         <article>
         ...
         <article>
          ...
          <article>
             <h2 class="titre_majBoldColor">Octobre</h2>
             <p>
               <span class="bold">Visite presse du chantier de rénovation de la copropriété Beccaria</span> qui vise une réduction de 70% des charges énergétiques, Paris 12<sup>e</sup>, en présence de 40 professionnels et couverte par l’AFP, France 3 et TF1.
             </p>
             <p>
               <span class="bold">Intervention sur l’accélération de la rénovation énergétique et l’observatoire</span> aux Rencontres de la Performance Environnementale du bâtiment organisées par Le Moniteur avec le soutien de l’ADEME.
             </p>
             <p>
          ...
          <article>
             <h2 class="titre_majBoldColor">Novembre</h2>
             <p>
             ...
             <p>
              Visite des Ministres <span class="bold">Nicolas Hulot et Jacques Mézard</span> sur le chantier de la copropriété du 24 rue Beccarria et lancement de la concertation sur le Projet de  Plan national de Rénovation énergétique des Bâtiments à l’Agence Parisienne du Climat lors d’une table ronde avec les acteurs majeurs du secteur.
             </p>
             <div class="img_container">
             <span class="credits_photo">© APC</span> <img src="img/faits_marquants/014.jpg" alt=""></div>
          </article>
          ...
          <article>
             ...
             <p>
              <span class="bold">  Plénière annuelle des 240 professionnels affiliés au dispositif CoachCopro métropolitain</span> en partenariat avec les Agences locales de l’Energie du territoire, la ville de Paris et l’Ademe Ile-de-France.
             </p>
             <div class="img_container">
             <span class="credits_photo">© APC</span> <img src="img/faits_marquants/015.jpg" alt=""></div>
